...
namespace webappli_ben_taleb_badreddine.Pages
{
    public class demandeModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            try
            {
                string connectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=PlancherExpert;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
                ...
                using (SqlConnection connection = new SqlConnection(connectionString)) //Création de la connection
                {
                    ...
                    String sql = "INSERT INTO demande (Id_client, Largeur, Longeur)" +
                        "SELECT c.Id_client, d.Largeur, d.Longeur" + "FROM clients c" +
                        "INNER JOIN demandes d ON c.Id_client = d.Id_client;"  ;//Déclaration de la requête
